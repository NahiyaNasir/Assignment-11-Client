...
const OurVolunteer = () => {
    return (
        <div>
            <section className="py-6 text-gray-50 bg-gradient-to-r from-sky-500 to-indigo-500">
	<div className="container grid grid-cols-2 gap-4 p-4 mx-auto md:grid-cols-4">
		<img src="https://i.ibb.co/W0872f0/medium-shot-people-with-food-donations-23-2149182009.jpg" alt="" className="w-full h-full col-span-2 row-span-2 rounded shadow-sm min-h-96 md:col-start-3 md:row-start-1 bg-gray-500 aspect-square" />
