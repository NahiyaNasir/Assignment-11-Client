	...
	<div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
		<a rel="noopener noreferrer" href="#" className="block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 bg-gray-900">
			...
			<div className="p-6 space-y-2 lg:col-span-5">
				...
				<h3 className="text-2xl font-semibold sm:text-4xl  uppercase">{category}</h3>
				<h3 className="text-2xl font-semibold sm:text-4xl ">{location}</h3>
				<h3 className="text-2xl font-semibold sm:text-4xl "> Volunteer Quantity:{number}</h3>
				<span className="text-xs text-gray-400 font-semibold">{deadline}</span>
				<p>{desc}.</p>
			</div>
		</a>
